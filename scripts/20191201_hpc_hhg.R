...
#   map(~as.matrix(dist(.x, diag = TRUE, upper = TRUE)))
# 
# d.c <- distances.connectivities
# d.a <- distances.activities
# 
# save_vars(c("d.c", "d.a"),
#           prefix = "distances of scaled features"
#           )


# calculating HHG per pair ------------------------------------------

load("./data/distances of scaled features_20191201_0130.RData")
...
save_vars(c("hhg.con", "hhg.act"),
          prefix = paste0("HHG_", counter, "_indices-", i, "-", j)
          )
